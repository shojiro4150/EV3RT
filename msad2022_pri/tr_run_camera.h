...
#define TR_RUN_CAMERA_L \
    ...
    .composite<BrainTree::ParallelSequence>(1, 2) \
        ...
        .composite<BrainTree::MemSequence>()                      /* RUN1: until passing Gate 3 */ \
            .composite<BrainTree::ParallelSequence>(1, 2) \
            ...
            .end() /* RUN2: until the intersection between Gate 3 and 4 */ \
            .composite<BrainTree::ParallelSequence>(1, 2) \
            ...
            .end() /* RUN3: until passing the intersection */ \
            .composite<BrainTree::ParallelSequence>(1, 2) \
            ...
            .end() /* RUN4: before the corner around Gate 4 */ \
            .composite<BrainTree::ParallelSequence>(1, 2) \
            ...
            .end() /* RUN6: the rest until detecting BLUE */ \
            ...
            .end() /* RUN7: Turn and move forward.  */ \
            .composite<BrainTree::MemSequence>() \
                .composite<BrainTree::ParallelSequence>(1, 2) \
