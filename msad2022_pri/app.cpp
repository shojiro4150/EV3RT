    ...
    tr_block = (BrainTree::BehaviorTree*) BrainTree::Builder()
        .composite<BrainTree::MemSequence>()
            ...
            .composite<BrainTree::ParallelSequence>(1,3)
                ...
                .leaf<RunAsInstructed>(-40,-50,0.0)    
                .leaf<IsColorDetected>(CL_BLACK)  
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(700000) // break after 10 seconds
                .leaf<RunAsInstructed>(-50,80,0.0)      
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(1400000) // break after 10 seconds
                .leaf<RunAsInstructed>(75,-60,0.0)      
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(500000)
                .leaf<TraceLine>(48, GS_TARGET, P_CONST, I_CONST, D_CONST, 0.0, TS_NORMAL)   
            .end() 
            .composite<BrainTree::ParallelSequence>(1,3)
