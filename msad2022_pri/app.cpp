    ...
    Status update() override {
        ...
        switch(color){
            ...
            case CL_YELLOW:
                ...
                break;
            case CL_GREEN:
                if (cur_rgb.r <= 30 && cur_rgb.b <= 50 && cur_rgb.g > 58) {
...
*/ 
    ...
    tr_block = (BrainTree::BehaviorTree*) BrainTree::Builder()
        .composite<BrainTree::MemSequence>()
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(858000) // break after 10 seconds
                .leaf<RunAsInstructed>(-40,77,0.0)      
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(420000) // break after 10 seconds
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(955000) // break after 10 seconds
