...
*/ 
    ...
    tr_block_r = (BrainTree::BehaviorTree*) BrainTree::Builder()
        .composite<BrainTree::MemSequence>()
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(450000) // 全身しながら大きく左に向けて旋回。黄色を目指す。
                .leaf<RunAsInstructed>(-55,
                                       505,0.0)       
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
...
*/
    ...
    tr_block_r = (BrainTree::BehaviorTree*) BrainTree::Builder()
        .composite<BrainTree::MemSequence>()
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(470000) // 全身しながら大きく左に向けて旋回。黄色を目指す。
                .leaf<RunAsInstructed>(-55,
                                       55,0.0)       
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
    ...
    tr_block_g = (BrainTree::BehaviorTree*) BrainTree::Builder()
        .composite<BrainTree::MemSequence>()
            ...
            .composite<BrainTree::ParallelSequence>(1,3)
                ...
                .end()
                .leaf<IsTimeEarned>(1000000) // break after 10 seconds
                .leaf<RunAsInstructed>(43,
                                       43,0.0)   //グレー検知後、丸穴あき部分があるため少し前進    
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(565000) // break after 10 seconds
                .leaf<RunAsInstructed>(-50,
                                       50,0.0) //左に旋回。ライントレース準備。
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(780000) //青検知後、大きく右旋回。向きを整える。
                .leaf<RunAsInstructed>(50,
                                       -50,0.0)         
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
    ...
    tr_block_y = (BrainTree::BehaviorTree*) BrainTree::Builder()
        .composite<BrainTree::MemSequence>()
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(770000) //青検知後、大きく右旋回。向きを整える。
                .leaf<RunAsInstructed>(50,
                                       -50,0.0)         
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
