    ...
    Status update() override {
        ...
        switch(color){
            ...
            case CL_BLUE:
                ...
                break;
            case CL_RED:
                if (cur_rgb.r - cur_rgb.b >= 50 && cur_rgb.r > 95 && cur_rgb.g < 30) {
...
*/ 
    ...
    tr_block = (BrainTree::BehaviorTree*) BrainTree::Builder()
        .composite<BrainTree::MemSequence>()
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(1800000) // break after 10 seconds
            ...
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(1750000) // break after 10 seconds
                .leaf<RunAsInstructed>(-60,70,0.0)      
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
            ...
            .composite<BrainTree::ParallelSequence>(1,3)
                ...
                .leaf<TraceLine>(47, GS_TARGET, P_CONST, I_CONST, D_CONST, 0.0, TS_OPPOSITE)  
            .end()
            .composite<BrainTree::ParallelSequence>(1,3)
                .leaf<IsTimeEarned>(2000000) // break after 10 seconds
